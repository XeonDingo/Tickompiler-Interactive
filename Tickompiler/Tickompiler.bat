...
:repeat
cls
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Tickompiler Interactive (1.2.7)~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo [                                          1  - Extract Games                                                          ]
echo [                                          1A - Extract games w/ tempo file                                            ]
echo [                                          2  - Convert *.bin to *.tickflow                                            ]
echo [                                          2A - Convert all *.bin to *.tickflow                                        ]
echo [                                          3  - Convert *.tickflow to *.bin                                            ]
echo [                                          3A - Convert all *.tickflow to *.bin                                        ]
echo [                                          4  - Pack games into c00.bin                                                ]
echo [                                          RE - Reopen "Game Files" folder                                             ]
echo [                                          S  - Switch to %theme% theme                                                  ]
echo [                                          D  - Open Tickflow Documentation                                            ]
echo [                                          L  - Show Tickompiler License                                               ]
echo [                                          C  - Open Changelog                                                         ]
echo [                                          R  - Open Credits                                                           ]
echo [                                          E  - Exit                                                                   ]
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
IF "%answer%"=="E" goto exit
IF "%answer%"=="2A" goto convall
IF "%answer%"=="2a" goto convall
IF "%answer%"=="3A" goto convallttb
IF "%answer%"=="3a" goto convallttb
...
IF "%answer%"=="d" goto docs
IF "%answer%"=="1A" goto extracttempo
IF "%answer%"=="1a" goto extracttempo
...
cls
echo Ver. 1.2.7
echo 		  - Set startup theme to dark an not white.
echo 		  - Bug Fixes
echo Ver. 1.2.6
echo 		  - Redesigned  the home menu, making it easier to read
echo 		  - Bug Fixes
echo Ver. 1.2.5
echo 		  - Bug fixes
echo Ver. 1.2.4
...
echo Creator of Tickompier Interactive: Xeon Dingo
